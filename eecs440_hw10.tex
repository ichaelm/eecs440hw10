...
\begin{homeworkProblem}
	...
	Consider that $T$ is constructed by picking a random sample from $U$ $n$ times, where $n$ is the size of both $U$ and $T$. Each sample in $U$ has a probability $\frac{1}{n}$ of being picked each time. To look at the probability of each given sample never being put in $T$, take the probability of any sample not being picked in a given pick, $1-\frac{1}{n}$, and consider it being repeated n times. This makes the probability of any sample in $U$ not being put into $T$ $(1-\frac{1}{n})^n$. This will also be the proportion of $U$ that is not in $T$. So the proportion of $U$ than is in $T$ is $1-(1-\frac{1}{n})^n$.
	
	
	
	As n becomes large, $\lim_{n\to\infty} 1-(1-\frac{1}{n})^n = 1-\frac{1}{e} \approx 0.63$ due to the definition of $e$. 
